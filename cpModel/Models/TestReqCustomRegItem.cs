...
{
    public partial class TestReqCustomRegItem: ITrackableEntity, IReplicableEntity, ILockableEntity
    {
        ...
        public int TestReqCustomRegItemId { get; set; }
