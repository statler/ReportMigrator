...
{
    public partial class rptProgClaimRates : rptTemplate
    {
        public override string BaseReportName { get; set; } = "Progress Claim (with qty and vals)";
        ...
        public rptProgClaimRates()
        {
            ...
            ReportTitle = "Progress Claim (with qty and vals)";
