...
namespace cpReportDefinitions.PaymentRep
{
    public partial class rptScheduleRelations : rptTemplate
    {
        ...
        private void RptScheduleRelations_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        private void DetailReport_Itp_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            e.Cancel = OnlyShowUnallocWt || OnlyShowUnallocItp || !(_currSI != null && _currSI.Itps.Count > 0);
        }
        private void DetailReport_Wt_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
